...
CREATE TABLE "Messages" (
  ...
  "SenderID" int4 NOT NULL REFERENCES "Users"("ID") ON DELETE CASCADE,
  "ReceiverID" int4 NOT NULL REFERENCES "Users"("ID") ON DELETE CASCADE,
...
-- ----------------------------
BEGIN;
INSERT INTO "Users" VALUES (1, 'user1', '123', 'Tran Van A', 'tva@gmail.com', '1998-03-14 00:00:00.000', 1);
INSERT INTO "Users" VALUES (2, 'user2', '123', 'Nguyen Van B', 'nvb@gmail.com', '2000-09-01 00:00:00.000', 1);
INSERT INTO "Users" VALUES (3, 'user3', '123', 'Le Thi C', 'ltc@gmail.com', '1989-01-09 00:00:00.000', 1);
INSERT INTO "Users" VALUES (4, 'user4', '123', 'Ngo Van D', 'nvd@gmail.com', '2003-10-24 00:00:00.000', 1);
INSERT INTO "Users" VALUES (5, 'user5', '123', 'Phan Thi E', 'pte@gmail.com', '1980-05-15 00:00:00.000', 1);
COMMIT;
...
ALTER SEQUENCE "Categories_CatID_seq" RESTART WITH 8;
ALTER SEQUENCE "Products_ProID_seq" RESTART WITH 31;
ALTER SEQUENCE "OrderDetails_ID_seq" RESTART WITH 5;
ALTER SEQUENCE "Orders_OrderID_seq" RESTART WITH 3;
